namespace Grape.Migrations
{
    ...
    public partial class InitialGrape : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        LastModificationTime = c.DateTime(),
                        ModifiedByUserGuid = c.Guid(),
                        ModifiedByUserName = c.String(),
                        Description = c.String(),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_GpUser_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .Index(t => t.IsDeleted);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.GpUsers", new[] { "IsDeleted" });
